...
public abstract class AbstractExecutionStrategy implements RequestExecutionStrategy {
     ...
     *
     * <p> If this method returns without exceptions it means that some recovery steps were taken
     * and the strategy can retry the request execution. The strategy will be retrying request
     * executions until this method throws {@code ExecutionFailedException}.
     */

...
object Spine {
    private const val baseVersion = "2.0.0-SNAPSHOT.77"
    private const val coreVersion = "2.0.0-SNAPSHOT.91"
    ...
    object Stable {
        ...
        const val version = "1.9.0-SNAPSHOT.6"
        const val coreVersion = "1.9.0-SNAPSHOT.13"
        const val timeVersion = "1.9.0-SNAPSHOT.6"
